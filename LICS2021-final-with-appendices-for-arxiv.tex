...
such that $v\linkingof\gG$ only if $vw\tightnotin\eG$; each equivalence class
is a \bfit{colour}.
% \footnote{In \cite{hughes:pws} and \cite{hughes:fopws}
% adjacent vertices must have distinct colours, as
% is part of the standard definition of colouring in graph
% theory.
% We choose to omit this condition, since it is implied
