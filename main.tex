...
\begin{proof}
   By \cite[Proposition~7.6.1]{str:07:RTA}, we have a
  derivation $\vlder{\set{\wrD,\PE\fequ}}{\DDeri}{\PE H}{\PE G}$.
...
We first study the interactions between two rules (only non-trivial cases are
presented here):
\begin{itemize}
...
\vlderivation{
  \vlin{\cfaD}{}{\forall x.A}{
    \vlin{\wfaD}{(x \notin fv(\forall x.A))}{\forall x.\forall x.A}{
      \vlhy{\forall x.A}}}}
\leadsto
\vlderivation{
  \vlhy{\forall x.A}}
...
\vlderivation{
  \vlin{\mfaD}{}{\forall x.(A \vlor B)}{
    \vlin{\wfaD}{(x \notin fv(A))}{(\forall x.A) \vlor (\forall x.B)}{
      \vlhy{A \vlor (\forall x.B)}}}}
\leadsto
\vlderivation{
  \vlin{\fequ}{(x \notin fv(A))}{\forall x.(A \vlor B)}{
    \vlhy{A \vlor (\forall x.B)}}} 
\end{equation*}
...
\vlderivation{
  \vlin{\fequ}{(x \notin fv(B))}{(\forall x.A) \vlor B}{
    \vlin{\wfaD}{(x \notin fv(A \vlor B))}{\forall x.(A \vlor B)}{
      \vlhy{A \vlor B}}}}
\leadsto
\vlderivation{
  \vlin{\wfaD}{(x \notin fv(A))}{(\forall x.A) \vlor B}{
    ...
    \vlin{\fequ}{}{\forall x.((A \vlor B) \vlan (C \vlor D))}{
      \vlin{\wrD}{}{\forall x.((B \vlor A) \vlan (D \vlor C))}{
        \vlin{\wrD}{}{\forall x.((B \vlor A) \vlan D)}{
          \vlin{\faD}{(x \notin fv(B \vlan D))}{\forall x.(B \vlan D)}{
            \vlhy{B \vlan D}}}}}}
  \end{equation*}
