...
\vlderivation{
  \vlin{\acD}{}{\exists x.(\cneg{p}x \vlor (\forall y.py))}{
    \vlin{\mfaD}{}{\exists x.(\cneg{p}x \vlor (\forall y.(py \vlor py)))}{
      \vlin{\acD}{}{\exists x.(\cneg{p}x \vlor ((\forall y.py) \vlor (\forall
y.py)))}{
        \vlin{\fequ}{}{\exists x.((\cneg{p}x \vlor \cneg{p}x) \vlor ((\forall
y.py) \vlor (\forall y.py)))}{
          \vlin{\mexD}{}{\exists x.((\cneg{p}x \vlor (\forall y.py)) \vlor
(\cneg{p}x \vlor (\forall y.py)))}{
            \vlin{\exists}{}{(\exists x.(\cneg{p}x \vlor (\forall y.py))) \vlor
(\exists x.(\cneg{p}x \vlor (\forall y.py)))}{
              \vlin{\fequ}{}{(\cneg{p}w \vlor (\forall y.py)) \vlor (\exists
x.(\cneg{p}x \vlor (\forall y.py)))}{
                \vlin{\exists}{}{\forall y.((\cneg{p}w \vlor py) \vlor (\exists
x.(\cneg{p}x \vlor (\forall y.py))))}{
                  \vlin{\fequ}{}{\forall y.((\cneg{p}w \vlor py) \vlor
(\cneg{p}y \vlor (\forall y.py)))}{
                    \vlin{\wD}{}{\forall y.((py \vlor \cneg{p}y) \vlor
(\cneg{p}w \vlor (\forall y.py)))}{
...
FOCPs, each above the formula it proves.  The same FOCPs are shown in
