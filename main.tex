...
$\rectif\mexD$.
\begin{equation}
  \vlinf{\rectif\mfaD}{}{\Scons{\forall x.(Cx\vlor Dx)}}{\Scons{(\forall y.Cy)\vlor(\forall z.Dz)}}
  \qquad
  \vlinf{\rectif\mexD}{}{\Scons{\exists x.(Cx\vlor Dx)}}{\Scons{(\exists y.Cy)\vlor(\exists z.Dz)}}
\end{equation}
