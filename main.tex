...
\begin{thm}\label{thm:decompositionA}
  For every derivation $\upsmash{\vlder{\FOKS}{\Deri}{A}{\ttt}}$ there is a formula~$A_1$ not containing any occurence of $\fff$, such that there is a derivation:
  \begin{equation*}
    %\scalebox{.9}{$
    \vlderivation{
...
\begin{thm}\label{thm:CP-DI}
  ...
  whenever we have a derivation as in~\eqref{eq:decom} above, such that $\fff$ does not occur in~$A_1$, then
