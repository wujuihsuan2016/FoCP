...
\juihsuan{induces a bimatching $\rightarrow$ has an induced bimatching}
\end{lemma}
...
Retor\'e~\cite{retore:03,retore:99}\lutz{that ``handsome'' report he mentioned in
  the talk}\juihsuan{added. Check if it's the good one.}. We use it now for our sequentialization:
...
\juihsuan{missing reference added, check if it's the right one.}
\end{remark}
