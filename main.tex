...
automated and interactive theorem provers in particular\cite{paulson:isabelle}\todo{find references}, we still have
...
A \bfit{renaming} is a substitution $\sigma$ with $\sigma(x)\in\VAR$ for all variables.
...
We consider Gentzen's sequent calculus system $\FOLK$ \cite{gentzen:35:I}.
...
\end{prooftree}
\caption{Gentzen's sequent calculus $\FOLK$}
\end{center}
\end{figure}
