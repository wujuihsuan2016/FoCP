...
\begin{thm}\label{thm:LK1-decompose}
  ...
  \end{equation*}
\end{thm}
\juihsuan{maybe there is still some problem... (consider the proof

$\vlderivation{
   \vliin{\vlan}{}{\sqn{\ttt, a \vlan b, \cneg b}}{
   \vlin{\ax}{}{\sqn{b, \cneg b}}{
     \vlhy{}}}{
   \vlin{\wk}{}{\sqn{\ttt, a}}{
     \vlin{\ttt}{}{\sqn\ttt}{
       \vlhy{}}}}}
$, it doesn't seem possible to get rid of the $\wk$ rule using deep weakening)}
\begin{proof}
...
$ \vlderivation{
        \vltrl{}{\FOLK}{\Deri}{\sqns{\form{\Gamma}}}{
          ...
          \vlhy{}}{
          \vlhy{}}} $
Note that the instances of $\ctr$ and $\wk$ in $\Deri$ can be transformed into
derivations using $\cD$, $\wrD$ and the rules from $\FOMLL$.

\begin{equation*}
\vlderivation{
  \vlin{\ctr}{}{\sqns{\Gamma, A}}{
    \vlhy{\sqns{\Gamma, A, A}}}}
\leadsto
\vlderivation{
...
\begin{proof}
Suppose that such $\vlor$ node does not exist.
\todo{}
\end{proof}
...
\begin{proof}\label{lem:concomp_switching_fo}
