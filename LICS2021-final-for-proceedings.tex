...
a homomorphism from a 5-vertex partially coloured graph (with one colour) to a 4-vertex labelled graph.
...
\begin{thm}[\cite{Ler71,CLS81}]\label{thm:cograph}
...
\begin{proof}
  ...
  Details are in
  Appendix~A of~\cite{HSW21:arxiv}.
\end{proof}
...
\begin{proof}
  ...
  analysis in Appendix~B of~\cite{HSW21:arxiv}.
  This
...
\begin{proof}
  ...
  Appendix~C of~\cite{HSW21:arxiv}.
\end{proof}
